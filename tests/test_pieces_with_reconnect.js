...
async function testPiecesWithReconnect() {
  ...
  try {
    console.log('🚀 Testing pieces display with reconnection wait...\n');
    ...
    if (totalPieces > 0) {
      ...
      // Take screenshot
      await page.screenshot({ path: 'reconnect-test.png' });
      console.log('\nScreenshot saved as reconnect-test.png');
    }
