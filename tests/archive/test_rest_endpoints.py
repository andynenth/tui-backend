...
class RestEndpointTester:
    ...
    def test_endpoint(self, 
        ...
        try:
            ...
            if response.status_code not in expected_statuses:
                self.print_failure(f"Expected status {expected_statuses}, got {response.status_code}")
                return False
            ...
            if validate_response and response.status_code == 200:
                try:
                    ...
                    if validation_result is True:
                        ...
                        self.print_failure(f"Response validation failed: {validation_result}")
                        return False
            ...
            self.print_failure(f"Connection refused. Is the server running on {self.base_url}?")
            return False
        except Exception as e:
    ...
    def validate_detailed_health(self, data: Dict) -> Any:
        ...
        required_fields = ["status", "timestamp", "version", "uptime_seconds", 
                         "components", "memory_usage_mb", "active_rooms", "active_connections"]
    ...
    def run_system_tests(self):
        ...
        self.test_endpoint(
            ...
            "GET",
            "/system/stats",
            validate_response=lambda d: all(k in d for k in ["health", "websocket", "rooms"])
        )
    ...
    def run_all_tests(self):
        ...
        try:
            ...
            print(f"{Colors.FAIL}✗ Cannot connect to server at {self.base_url}{Colors.ENDC}")
