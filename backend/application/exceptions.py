...
class ValidationException(ApplicationException):
    ...
    def __init__(self, errors: Dict[str, str]):
        ...
        super().__init__(
            message=message, code="VALIDATION_ERROR", details={"errors": errors}
        )
        self.errors = errors
...
class UseCaseException(ApplicationException):
    ...
    def __init__(
        self, use_case: str, reason: str, details: Optional[Dict[str, Any]] = None
    ):
        """
        ...
        super().__init__(
            ...
            code="USE_CASE_ERROR",
            details={"use_case": use_case, "reason": reason, **(details or {})},
        )
