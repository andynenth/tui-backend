...
class NotificationService(ABC):
    ...
    @abstractmethod
    async def notify_player(self, player_id: str, message: str, data: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    @abstractmethod
    async def notify_room(self, room_id: str, message: str, data: Optional[Dict[str, Any]] = None) -> None:
        """
