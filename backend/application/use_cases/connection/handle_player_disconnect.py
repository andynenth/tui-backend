...
from application.dto.connection import HandlePlayerDisconnectRequest, HandlePlayerDisconnectResponse
    ...
    async def execute(self, request: HandlePlayerDisconnectRequest) -> HandlePlayerDisconnectResponse:
        ...
        try:
            async with self._uow:
                ...
                player.disconnect(request.room_id, activate_bot=request.activate_bot and game_in_progress)
