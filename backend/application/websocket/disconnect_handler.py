...
class DisconnectHandler:
    ...
    async def handle_player_disconnect(
        self, connection_info: Optional[Dict[str, Any]], room_id: str
    ) -> None:
        """
        ...
        try:
            ...
            async with uow:
                ...
                if room.game and room.game.is_started and not room.game.is_finished:
                    ...
                    await self._handle_ingame_disconnect(room, player_name, uow)
                else:
                    # Pre-game disconnect - treat as leave_room
                    await self._handle_pregame_disconnect(room, player_name, uow)
    ...
    async def _handle_ingame_disconnect(
        self, room: Any, player_name: str, uow: Any
    ) -> None:
        """
