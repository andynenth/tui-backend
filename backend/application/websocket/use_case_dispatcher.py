...
class UseCaseDispatcher:
    ...
    def _init_use_cases(self):
        ...
        self.client_ready_use_case = MarkClientReadyUseCase(self.uow, self.event_publisher)
        ...
        self.create_room_use_case = CreateRoomUseCase(self.uow, self.event_publisher, self.metrics)
        self.join_room_use_case = JoinRoomUseCase(self.uow, self.event_publisher, self.metrics)
        self.leave_room_use_case = LeaveRoomUseCase(self.uow, self.event_publisher, self.metrics)
        self.get_room_state_use_case = GetRoomStateUseCase(self.uow)
        self.add_bot_use_case = AddBotUseCase(self.uow, self.event_publisher, self.bot_service, self.metrics)
        self.remove_player_use_case = RemovePlayerUseCase(self.uow, self.event_publisher, self.metrics)
        ...
        try:
            ...
            logger.warning("Game services not available, game use cases will be limited")
            self.game_service = None
            self.game_state_store = None
    ...
    async def _handle_ping(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
        """Handle ping event"""
        ...
        return {
            "event": "pong",
            "data": {
                "server_time": response.server_time.isoformat() if hasattr(response, 'server_time') else time.time(),
                "sequence": response.sequence_number if hasattr(response, 'sequence_number') else request.sequence_number
            }
        }
    ...
    async def _handle_sync_request(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
        ...
        return {
            ...
            "data": {
                ...
                "events_missed": response.events_missed if hasattr(response, 'events_missed') else 0,
    ...
    async def _handle_create_room(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_join_room(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_leave_room(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_get_room_state(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_add_bot(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_start_game(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_declare(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_play(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_request_redeal(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_accept_redeal(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_decline_redeal(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_redeal_decision(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_player_ready(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _handle_leave_game(self, data: Dict[str, Any], context: DispatchContext) -> Dict[str, Any]:
    ...
    async def _ensure_legacy_visibility(self, room_id: str) -> None:
        ...
        try:
            ...
            logger.debug(f"Legacy bridge not available, skipping sync for room {room_id}")
        except Exception as e:
