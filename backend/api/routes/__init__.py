...
from .routes import router as api_router # Imports the router for RESTful API endpoints.
from .ws import router as ws_router # Imports the router for WebSocket communication.
from fastapi import APIRouter # Imports APIRouter from FastAPI to create a new router instance.
