...
RATE_LIMITING_LOG_VIOLATIONS = os.getenv("RATE_LIMITING_LOG_VIOLATIONS", "true").lower() == "true"
RATE_LIMITING_REDIS_ENABLED = os.getenv("RATE_LIMITING_REDIS_ENABLED", "false").lower() == "true"
