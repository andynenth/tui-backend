...
class AdapterEventConfig:
    ...
    def __init__(self):
        ...
        self.default_mode = self._get_mode_env("ADAPTER_DEFAULT_MODE", AdapterMode.DIRECT)
        ...
        self.adapter_modes: Dict[str, AdapterMode] = {
            ...
            "get_room_state": self._get_adapter_mode("GET_ROOM_STATE", AdapterMode.DIRECT),
            "add_bot": self._get_adapter_mode("ADD_BOT", AdapterMode.DIRECT),
            "remove_player": self._get_adapter_mode("REMOVE_PLAYER", AdapterMode.DIRECT),
            
            # Lobby adapters
            "request_room_list": self._get_adapter_mode("REQUEST_ROOM_LIST", AdapterMode.DIRECT),
            ...
            "request_redeal": self._get_adapter_mode("REQUEST_REDEAL", AdapterMode.DIRECT),
            "accept_redeal": self._get_adapter_mode("ACCEPT_REDEAL", AdapterMode.DIRECT),
            "decline_redeal": self._get_adapter_mode("DECLINE_REDEAL", AdapterMode.DIRECT),
            "redeal_decision": self._get_adapter_mode("REDEAL_DECISION", AdapterMode.DIRECT),
    ...
    def enable_adapter_events(self, adapter_name: str, mode: AdapterMode = AdapterMode.EVENT):
