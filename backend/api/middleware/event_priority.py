...
class EventPriorityManager:
    ...
    GRACE_ELIGIBLE_EVENTS: Set[str] = {
        "play", "play_pieces", "declare", "start_game"
    }
    
    def __init__(self):
        self.grace_periods: Dict[str, Dict[str, float]] = {}  # client_id -> event -> expiry
        self.grace_config = GracePeriodConfig()
        self.warnings_sent: Dict[str, Dict[str, float]] = {}  # client_id -> event -> last_warning
    ...
    def adjust_rate_limit_for_priority(self, 
                                     event_name: str, 
                                     base_limit: int,
                                     current_usage: int) -> tuple[int, bool]:
        """
    ...
    def apply_grace_period_multiplier(self, 
                                    client_id: str, 
                                    event_name: str,
                                    base_limit: int) -> int:
