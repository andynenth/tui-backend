...
class DomainIntegration:
    ...
    def __init__(self):
        ...
        self.game_adapter = DomainGameAdapter(
            room_repository=self.room_repository, event_publisher=self.event_bus
        )
    ...
    async def handle_message(
        ...
        if event == "start_game":
            ...
            return await self.game_adapter.handle_declare(websocket, message, room_id)
        elif event in ["play", "play_pieces"]:
            return await self.game_adapter.handle_play(websocket, message, room_id)
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "repositories": {"room": self.room_repository.__class__.__name__},
            "event_bus": {
                "type": self.event_bus.__class__.__name__,
                "handlers": len(self.event_bus._global_handlers),
            },
            "adapters": {"game": "DomainGameAdapter"},
        }
