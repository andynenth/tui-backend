...
GAME_ADAPTER_ACTIONS = {
    "start_game", "declare", "play", "play_pieces",  # play_pieces is legacy alias
...
async def handle_game_messages(
    ...
    if action == "start_game":
        ...
        return await _handle_request_redeal(websocket, message, room_state, broadcast_func)
    elif action == "accept_redeal":
        return await _handle_accept_redeal(websocket, message, room_state, broadcast_func)
    elif action == "decline_redeal":
        return await _handle_decline_redeal(websocket, message, room_state, broadcast_func)
    elif action == "redeal_decision":
        return await _handle_redeal_decision(websocket, message, room_state, broadcast_func)
    elif action == "player_ready":
        return await _handle_player_ready(websocket, message, room_state, broadcast_func)
