...
async def test_transition_validation():
    ...
    for from_phase, to_phase in invalid_tests:
        ...
        assert is_invalid, f"Expected {from_phase.value} → {to_phase.value} to be invalid"
...
async def main():
    ...
    try:
        ...
        print("✅ All 7 phases: waiting, preparation, declaration, turn, turn_results, scoring, game_over")
