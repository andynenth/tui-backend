...
class LiveServerCapture:
    ...
    async def capture_message_type(self, action: str, test_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            async with websockets.connect(endpoint) as websocket:
                ...
                try:
                    ...
                    print(f"   ⚠️  No direct response for {action} (might be broadcast-only)")
...
class InteractiveLiveCapture:
    ...
    async def start(self):
        ...
        print("Commands: connect, create_room, join_room, start_game, declare, play, quit")
        print()
    ...
    async def listen(self):
        ...
        try:
            async for message in self.websocket:
                ...
                if data.get("event") in ["room_created", "game_started", "phase_change"]:
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Capture golden masters from live server")
