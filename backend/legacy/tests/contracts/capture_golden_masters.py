...
TEST_SCENARIOS = {
    ...
    "create_room": [
        ...
        {
            "message": {"action": "create_room", "data": {"player_name": "VeryLongPlayerName20"}},
            "room_state": None,
    ...
    "join_room": [
        {
            "message": {"action": "join_room", "data": {"room_id": "ABC123", "player_name": "Bob"}},
            "room_state": {
                "room_id": "ABC123",
        ...
        {
            "message": {"action": "join_room", "data": {"room_id": "FULL01", "player_name": "Eve"}},
            "room_state": {
                "room_id": "FULL01",
                "players": [
                    {"name": "Alice", "slot": 0},
        ...
        {
            "message": {"action": "join_room", "data": {"room_id": "NOEXIST", "player_name": "Frank"}},
            "room_state": None,
    ...
    "declare": [
        {
            "message": {"action": "declare", "data": {"player_name": "Alice", "value": 3}},
            "room_state": {
                "room_id": "GAME01",
                "phase": "DECLARATION",
                "players": [
        ...
        {
            "message": {"action": "declare", "data": {"player_name": "Alice", "value": 0}},
            "room_state": {
                "room_id": "GAME01",
                "phase": "DECLARATION",
    ...
    "play": [
        {
            "message": {"action": "play", "data": {"player_name": "Alice", "indices": [0, 1, 2]}},
            "room_state": {
                "room_id": "GAME01",
                "phase": "TURN",
        ...
        {
            "message": {"action": "play", "data": {"player_name": "Alice", "indices": [0]}},
            "room_state": {
                "room_id": "GAME01",
                "phase": "TURN",
                "current_player": "Alice",
                ...
                "players": [
                    {"name": "Alice", "hand": ["G2", "B7", "B6"]}
                ]
            },
            "description": "Valid play with 1 piece"
        },
        {
            "message": {"action": "play", "data": {"player_name": "Bob", "indices": [0, 1]}},
            "room_state": {
                "room_id": "GAME01",
                "phase": "TURN",
                "current_player": "Alice",
...
class CurrentSystemSimulator:
    ...
    async def handle_message(self, message: Dict[str, Any], room_state: Optional[Dict[str, Any]] = None):
        ...
        if action == "ping":
            ...
            self.broadcasts.append({
                ...
                "event": "room_update",
                "data": {
                    "players": room_state.get("players", []) + [{"name": player_name, "slot": slot}],
