    ...
    if choice == 'y':
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                print("2. Run behavioral tests: python3 tests/behavioral/run_behavioral_tests.py")
                print("3. Generate report: python3 tests/contracts/monitor_compatibility.py --report")
            else:
