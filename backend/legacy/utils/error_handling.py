...
class ErrorHandlingService:
    ...
    def handle_validation_error(
        self, field: str, value: Any, constraint: str, request_id: Optional[str] = None
    ) -> HTTPException:
    ...
    def handle_game_logic_error(
        ...
        return self.create_websocket_error(
            code=code, message=message, context=context, request_id=request_id
        )
    ...
    def handle_network_error(
        ...
        context = {"connection_id": connection_id, "room_id": room_id}
    ...
    def handle_system_error(
        ...
        context = {"operation": operation, "error_type": type(original_error).__name__}
    ...
    def _determine_validation_error_code(self, constraint: str) -> ErrorCode:
        ...
        if "required" in constraint_lower or "missing" in constraint_lower:
            ...
            "range" in constraint_lower
            or "min" in constraint_lower
            or "max" in constraint_lower
        ):
    ...
    def _log_error(
        self, error: StandardError, context: Optional[Dict[str, Any]] = None
    ):
    ...
    def get_error_statistics(self) -> Dict[str, Any]:
        ...
        return {
            "error_counts": {
                code.name: count for code, count in self.error_counts.items()
            },
...
def validate_required_field(
    value: Any, field_name: str, request_id: Optional[str] = None
):
...
def validate_field_type(
    value: Any, expected_type: type, field_name: str, request_id: Optional[str] = None
):
