...
def create_async_method(sync_method: Callable[..., T]) -> Callable[..., asyncio.Future[T]]:
    """
    ...
    async def async_method(self, *args, **kwargs):
        ...
        return await loop.run_in_executor(
            _thread_pool,
            functools.partial(bound_method, *args, **kwargs)
        )
...
class AsyncCompatRoomManager:
    ...
    async def create_room(self, host_name: str) -> str:
        ...
        async with self._manager_lock:
            ...
            return await loop.run_in_executor(
                _thread_pool,
                self._sync_manager.create_room,
                host_name
            )
    ...
    async def delete_room(self, room_id: str) -> None:
        ...
        async with self._manager_lock:
            ...
            await loop.run_in_executor(
                _thread_pool,
                self._sync_manager.delete_room,
                room_id
            )
