...
class HistoricalWriter:
    ...
    async def queue_event(
        ...
        logger.debug(f"Queued {event_type} event for room {room_id} (priority={priority})")
    ...
    async def _build_round_data(self, room_id: str, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _compress_old_games(self):
        ...
        logger.info(f"Starting compression of games older than {self.compression_age_days} days")
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_batch_size": self._events_written / self._batches_written if self._batches_written > 0 else 0
        }
...
async def initialize_historical_writer(
    ...
    global _historical_writer
    _historical_writer = HistoricalWriter(v1_store, v2_store, batch_size, batch_interval)
