...
class SimplePlayHistoryService:
    ...
    def _build_current_round(self, game: Any) -> Dict[str, Any]:
        ...
        if (
            hasattr(game, "round_starter_index")
            and game.round_starter_index is not None
        ):
        ...
        for player in game.players:
            ...
            declarations.append(
                {
                    "player": player.name,
                    "declared": player.declared_pile_count
                    if hasattr(player, "declared_pile_count")
                    else 0,
                    "hand": hand_pieces,
                    "timestamp": "2025-01-01T00:00:00Z",
                }
    ...
    def _build_scoring(self, game: Any) -> Dict[str, Any]:
        ...
        return {"players": players_scoring, "bonuses": []}  # No bonuses for now
