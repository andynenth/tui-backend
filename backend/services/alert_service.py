...
class AlertService:
    ...
    def check_response_time(
        self, operation: str, duration_ms: float, context: Dict
    ) -> Optional[Alert]:
        """
    ...
    def create_custom_alert(
        self, alert_type: str, severity: str, message: str, context: Dict
    ) -> Alert:
        """Create a custom alert."""
        alert = Alert(
            alert_type=alert_type, severity=severity, message=message, context=context
        )
    ...
    def _trigger_alert(self, alert: Alert):
        ...
        log_method(
            ...
            extra={"alert": alert.to_dict(), "event": "performance_alert"},
        )
