...
class MetricsCollector:
    ...
    def __init__(self, window_size_minutes: int = 60):
        ...
        )  # 1 hour of second-by-second data
        ...
        with self._lock:
            ...
            for key, count in self.request_counts.items():
                ...
                summary["endpoints"][key] = {
                    ...
                    "error_rate": (
                        self.error_counts.get(key, 0) / count if count > 0 else 0
                    ),
...
class PlayHistoryMetrics:
    ...
    def get_play_history_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_rounds_per_request": sum(self.rounds_per_request)
            / len(self.rounds_per_request),
