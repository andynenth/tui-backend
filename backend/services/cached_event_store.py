        ...
        if self.use_v2 and self.v2_store:
            ...
            if summary:
                ...
                return {
                    ...
                    "current_phase": latest_round.get("phase") if latest_round else "WAITING",
                    "phase_data": latest_round.get("phase_data") if latest_round else {},
                    "scores": latest_round.get("cumulative_scores") if latest_round else {},
