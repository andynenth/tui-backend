...
class TestEventBroadcastMapper:
    ...
    def test_map_simple_event(self, mapper):
        ...
        event = RoomCreated(room_id="room456", host_name="Charlie", metadata=metadata)
    ...
    def test_map_event_with_context(self, mapper, sample_context):
        ...
        event = PlayerJoinedRoom(
            room_id="room123", player_name="Carol", slot=3, metadata=metadata
        )
    ...
    def test_map_unmapped_event(self, mapper):
        ...
        metadata = EventMetadata(user_id="test_user")
        event = GameStarted(
            room_id="room123", round_number=1, starter_player="Alice", metadata=metadata
        )
    ...
    def test_custom_target_id_extractor(self, mapper):
        ...
        event = GameStarted(
            room_id="room789", round_number=1, starter_player="Alice", metadata=metadata
        )
    ...
    def test_mapper_error_handling(self, mapper):
        ...
        mapper.register(
            ...
            "phase_change",
            "room",
            lambda e, ctx: {"error": 1 / 0},  # This will raise ZeroDivisionError
        )
    ...
    def test_complex_mapping_function(self, mapper):
        ...
        def complex_mapper(
            event: PiecesPlayed, context: Dict[str, Any]
        ) -> Dict[str, Any]:
        ...
        mapper.register(PiecesPlayed, "turn_played", "room", complex_mapper)
        ...
        context = {"turn_number": 5, "timestamp": 1234567890}
