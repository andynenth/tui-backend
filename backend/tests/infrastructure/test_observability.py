...
class TestStructuredLogging:
    ...
    def test_basic_logging(self):
        ...
        config = LogConfig(level=LogLevel.DEBUG, format=LogFormat.JSON)
    ...
    def test_log_levels(self):
        ...
        config = LogConfig(level=LogLevel.WARNING, format=LogFormat.TEXT)
        logger = StructuredLogger("test", config)
    ...
    def test_context_logging(self):
        ...
        child_logger = logger.with_context(request_id="req123", user_id="user456")
    ...
    async def test_async_logger(self):
        ...
        config = LogConfig(level=LogLevel.INFO, async_mode=True, buffer_size=10)
...
class TestMetricsCollection:
    ...
    def test_metric_tags(self):
        ...
        config = MetricConfig(prefix="test", default_tags=[MetricTag("env", "test")])
        collector = InMemoryMetricsCollector(config)
