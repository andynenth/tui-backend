...
class TestAIDecisionAnalysis:
    ...
    def test_ai_analysis_placeholder_when_no_data(self):
        ...
        assert 'declaration_reasoning' in ai_analysis or 'turn_play_reasoning' in ai_analysis
        ...
        self.game.ai_decision_history = {
            'Bot 3': {
                'strategy_plan': {
                    ...
                    'assigned_combos': [
                        {'type': 'STRAIGHT', 'pieces': ['CHARIOT_RED', 'HORSE_RED', 'CANNON_RED']},
