...
from domain.services.turn_resolution import (
    TurnResolutionService, TurnPlay, TurnResult
)
...
class TestTurnResolution:
    ...
    def test_turn_play_beats(self):
        ...
        play1 = TurnPlay.create("Alice", [
            Piece.create("ELEPHANT_RED"),
            Piece.create("ELEPHANT_RED")
        ])
        play2 = TurnPlay.create("Bob", [
    ...
    def test_resolve_turn_with_required_piece_count(self):
        ...
        plays = [
            ...
            TurnPlay.create("Bob", [                                  # 2 pieces
                Piece.create("SOLDIER_RED"),
                Piece.create("SOLDIER_RED")
            ]),
            TurnPlay.create("Carol", [                                # 2 pieces
    ...
    def test_validate_turn_plays(self):
        ...
        plays = [
            ...
            TurnPlay.create("Bob", [
                Piece.create("GENERAL_RED"),
                Piece.create("SOLDIER_BLACK")  # Invalid
            ]),
            TurnPlay.create("Carol", [
                Piece.create("SOLDIER_RED"),
                Piece.create("SOLDIER_RED")
            ])
        ]
    ...
    def test_get_turn_summary(self):
        ...
        winning_play = TurnPlay.create("Alice", [
            Piece.create("GENERAL_RED"),
