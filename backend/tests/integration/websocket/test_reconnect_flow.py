...
async def simulate_websocket_flow():
    ...
    initial_message = {
        "event": "client_ready",
        "data": {"player_name": "Bob", "timestamp": 1234567890},
    }
    ...
    events = [
        ...
        {"event": "play", "data": {"player": "Charlie", "pieces": [1, 2]}},
        {"event": "turn_resolved", "data": {"winner": "Charlie", "pieces_won": 2}},
    ]

    print("   Events queued for Bob:")
    for i, event in enumerate(events, 1):
        critical = event["event"] in [
            "phase_change",
            "turn_resolved",
            "score_update",
            "game_ended",
    ...
    reconnect_message = {
        "event": "client_ready",
        "data": {"player_name": "Bob", "timestamp": 1234567900},
    }
    ...
    reconnect_broadcast = {
        ...
        "data": {"player_name": "Bob", "resumed_control": True, "is_bot": False},
    }
