...
class TestDomainCompatibility:
    ...
    def sample_room(self):
        ...
        room = Room(room_id="TEST123", host_name="TestHost", max_slots=4)
    ...
    @pytest.mark.asyncio
    async def test_create_room_generates_proper_response(
        self, mock_uow, mock_event_publisher
    ):
        ...
        try:
            ...
            assert not hasattr(
                saved_room, "current_game"
            )  # Should NOT have 'current_game'
