...
class TestLobbyWebSocketIntegration:
    ...
    async def test_room_creation_broadcasts_to_all_lobby_users(
        ...
        list_response = await dispatcher.dispatch(
            "get_rooms",
            {},
            context2
        )
    ...
    @pytest.mark.asyncio
    async def test_concurrent_room_operations(
        self, setup_connections, dispatcher
    ):
    ...
    @pytest.mark.asyncio
    async def test_room_full_status_update(
        self, setup_connections, dispatcher
    ):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_in_lobby_updates(
        self, setup_connections, dispatcher
    ):
        ...
        normal_response = await dispatcher.dispatch(
            "get_rooms",
            {},
            context
        )
