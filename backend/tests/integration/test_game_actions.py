...
class TestGameActionIntegration:
    ...
    async def test_game_action_performance(self, mock_websocket, sample_game):
        ...
        game_messages = [
            {"action": "declare", "data": {"player_id": f"player_{i%2+1}", "pile_count": 2}}
            for i in range(20)
        ]
