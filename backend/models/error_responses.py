...
def create_error_response(
    ...
    """
    error_detail = ErrorDetail(code=code, message=message, field=field, context=context)

    error_response = ErrorResponse(error=error_detail, path=path)

    return error_response, status_code


def create_validation_error_response(
    errors: List[Dict[str, Any]], path: Optional[str] = None
    ...
    validation_response = ValidationErrorResponse(errors=error_details, path=path)
