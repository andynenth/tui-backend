...
class CompressedEvent:
    ...
    @classmethod
    def from_declaration_events(cls, declaration_events: List[Dict[str, Any]]) -> "CompressedEvent":
        ...
        declaration_data = {
            ...
            "_compression_ratio": 1 / len(declaration_events) if declaration_events else 1.0,
        }
