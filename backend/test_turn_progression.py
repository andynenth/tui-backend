...
async def test_turn_progression():
    ...
    game.player_hands = {
        ...
        "Bot 2": [Piece("GENERAL_RED"), Piece("HORSE_BLACK"), Piece("CANNON_RED")],  # Bot 2 has RED_GENERAL
    ...
    if next_player == expected_next:
        ...
        print(f"❌ The bot manager will broadcast next_player: {result.get('next_player')}")
        print(f"❌ This causes the frontend to show 'Waiting for other players' indefinitely")
