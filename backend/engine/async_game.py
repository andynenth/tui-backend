...
class AsyncGame(Game):
    ...
    async def deal_pieces(self) -> Dict[str, Any]:
        ...
        async with self._deal_lock:
            ...
            logger.info(f"Dealt pieces to {len(self.players)} players in {elapsed:.2f}ms")
    ...
    async def record_player_declaration(self, player_name: str, declaration: int) -> Dict[str, Any]:
        """
    ...
    async def get_game_state(self) -> Dict[str, Any]:
        ...
        async with self._game_lock:
            return {
                ...
                "last_turn_winner": self.last_turn_winner.name if self.last_turn_winner else None,
    ...
    def play_turn_sync(self, player_name: str, piece_indexes: List[int]) -> Dict[str, Any]:
