...
class TurnNumberSyncTester:
    ...
    async def test_01_initial_turn_number(self, game, state_machine):
        ...
        self.log_test("01. Initial Turn Number", "RUNNING", "Starting turn phase and checking initial turn number")
        ...
        success = self.assert_equal(
            game.turn_number, 
            1, 
            "Initial turn number should be 1"
        )
        ...
        if success:
            self.log_test("01. Initial Turn Number", "PASS", "Initial turn number correctly set to 1")
    ...
    async def test_02_complete_first_turn(self, game, state_machine):
        ...
        self.log_test("02. Complete First Turn", "RUNNING", "Playing through first complete turn")
        ...
        success &= self.assert_equal(
            game.turn_number, 
            1, 
            "Turn number should still be 1 for first turn"
        )
        
        if success:
            self.log_test("02. Complete First Turn", "PASS", "First turn completed correctly")
    ...
    async def test_03_auto_start_second_turn(self, game, state_machine):
        ...
        self.log_test("03. Auto-Start Second Turn", "RUNNING", "Waiting for auto-start and checking turn number")
        ...
        success = self.assert_equal(
            game.turn_number, 
            2, 
            "Turn number should increment to 2 for second turn"
        )
        ...
        if success:
            self.log_test("03. Auto-Start Second Turn", "PASS", "Second turn auto-started with correct turn number")
    ...
    async def test_04_phase_data_broadcasting(self, game, state_machine):
        ...
        self.log_test("04. Phase Data Broadcasting", "RUNNING", "Checking if phase_change is broadcast after auto-start")
        ...
        success &= self.assert_true(
            'turn_order' in phase_data, 
            "Broadcast phase data should contain turn_order"
        )
        
        if success:
            self.log_test("04. Phase Data Broadcasting", "PASS", "Phase data correctly prepared for broadcast")
    ...
    async def test_05_third_turn_increment(self, game, state_machine):
        ...
        self.log_test("05. Third Turn Increment", "RUNNING", "Testing turn number continues to increment correctly")
        ...
        success = self.assert_equal(
            game.turn_number, 
            3, 
            "Turn number should increment to 3 for third turn"
        )
        ...
        if success:
            self.log_test("05. Third Turn Increment", "PASS", "Turn number continues to increment correctly")
