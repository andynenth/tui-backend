...
describe('RoundStartUI Component Tests', () => {
  ...
  describe('Scenario 5: CSS Animation Test', () => {
    it('should have correct CSS classes for animations', () => {
      ...
      expect(
        container.querySelector('.rs-starter-section')
      ).toBeInTheDocument();
    });
...
describe('RoundStartContent Component Tests', () => {
  ...
  describe('Component Structure', () => {
    it('should render all required sections', () => {
      ...
      expect(
        roundSection.querySelector('.rs-round-number')
      ).toBeInTheDocument();
      ...
      expect(starterSection).toBeInTheDocument();
      expect(
        starterSection.querySelector('.rs-starter-name')
      ).toBeInTheDocument();
      expect(
        starterSection.querySelector('.rs-starter-reason')
      ).toBeInTheDocument();
