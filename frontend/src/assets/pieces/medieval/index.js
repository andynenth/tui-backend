/**
 * Medieval Theme SVG Piece Assets Index
 *
 * This file provides imports for medieval theme xiangqi piece SVGs.
 * These SVGs have medieval-style designs with classic color scheme.
 */

// Import all medieval SVG files from current directory
